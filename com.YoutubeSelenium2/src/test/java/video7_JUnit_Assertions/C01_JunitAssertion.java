...
public class C01_JunitAssertion {
    ...
    public void test01(){
        ...
        //5.Verfy login to your account is visible
       ...
       driver.findElement(By.xpath("//button[@data-qa='login-button']")).click(); // sadece click için locate için ojbe oluşturmaya gerek yok.

        //8.Verif that 'Logged in as username' is visible
        WebElement loggedInYazisi=driver.findElement(By.xpath("//a[text()=' Logged in as ']"));
        Assert.assertTrue(loggedInYazisi.isDisplayed());

        //9.Click 'Log out' button
